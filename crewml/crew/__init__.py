...
Phase 2 builds this out day by day. Day 5 shipped the skeleton: the shared
:class:`CrewState`, seven node stubs, and the wired graph with the Critic loop
and its ``max_iterations`` guard. Days 7-11 replaced the stubs with real agents;
as of Day 11 (Ensembler + Reporter) every node is a real specialist.
"""
